...
class WideBasic(nn.Module):
    def __init__(self, in_planes, planes, dropout_rate, stride=1, bn_types=None):
        ...
        self.bn1 = MultiBatchNorm('2d', bn_types, in_planes, momentum=0.9)
        self.conv1 = nn.Conv2d(in_planes, planes, kernel_size=3, padding=1, bias=True)
        self.dropout = nn.Dropout(p=dropout_rate)
        # self.bn2 = nn.BatchNorm2d(planes, momentum=0.9)
        self.bn2 = MultiBatchNorm('2d', bn_types, planes, momentum=0.9)
...
class WideResNetMultiBN(nn.Module):
    def __init__(self, depth, widen_factor, dropout_rate, num_classes, bn_types):
        super(WideResNetMultiBN, self).__init__()
        self.in_planes = 16
        ...
        self.bn1 = MultiBatchNorm('2d', bn_types, nStages[3], momentum=0.9)
